...
# ///
"""
ftl2-iac-loop — AI Reconciliation Loop
...
REPO_URL = "https://github.com/benthomasson/ftl2-iac-loop"
UPDATE_EXIT_CODE = 42
...
def _get_startup_commit() -> str | None:
    ...
    try:
        ...
        dist = importlib.metadata.distribution("ftl2-iac-loop")
...
def save_rule(rule_data: dict, rules_dir: str | Path) -> Path:
    ...
    header = f'"""{description}\nCreated: {timestamp} by ftl2-iac-loop.\nTrigger: {condition_desc}\n"""\n\n'
...
def generate_script_from_history(
    ...
    lines = [
        '#!/usr/bin/env python3',
        '"""',
        f'FTL2 script generated by ftl2-iac-loop.',
...
async def post_convergence_review(
    ...
    prompt = textwrap.dedent(f"""\
        ...
        2. FEATURE REQUESTS — What changes to ftl2-iac-loop would make your job easier?
...
def cli():
    ...
    parser = argparse.ArgumentParser(
        description="ftl2-iac-loop — AI reconciliation loop for infrastructure",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=textwrap.dedent("""\
            examples:
              ftl2-iac-loop "nginx installed and running"
              ftl2-iac-loop "ensure /tmp/demo exists as a directory" --dry-run
              ftl2-iac-loop "PostgreSQL 16 with mydb database" -i inventory.yml
        """),
    )
    ...
    if args.tui:
        from ftl2_iac_loop_tui import run_tui
